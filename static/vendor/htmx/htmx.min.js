var htmx = function() {
	...
	function Te(e, o, i) {
		...
		if (n) {
			...
			o.parentNode.removeChild(o);
			ae(ne().body, "htmx:oobErrorNoTarget", {
				content: o
			})
		}
		return e
	...
	function pt(e, t, n) {
		...
		if (r) {
			try {
				...
				const o = r.source;
				ae(ne().body, "htmx:eventFilter:error", {
					error: e,
					source: o
				});
				return true
	...
	function Vt(t, e) {
		...
		while (i.length > 0) {
			try {
				...
				ae(ne().body, "htmx:historyCacheError", {
					cause: e,
					cache: i
				});
				i.shift()
	...
	function On(t) {
		if (t.responseURL && typeof URL !== "undefined") {
			try {
				...
				ae(ne().body, "htmx:badResponseUrl", {
					url: t.responseURL
				})
			}
		}
	...
	function qn(e, t, n) {
		...
		return he(e, "htmx:validateUrl", ue({
			url: o,
			sameHost: r
		}, n))
	}
	...
	function Mn(o, i) {
		...
		if (m.shouldSwap) {
			...
			let e = function() {
				try {
					if (c.type) {
						he(ne().body, "htmx:beforeHistoryUpdate", ue({
							history: c
						}, i));
						if (c.type === "push") {
							Jt(c.path);
