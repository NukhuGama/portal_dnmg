    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SUPER_ADMIN', 'Super Administrator'), ('ADMIN', 'Administrator'), ('HR_OFFICER', 'HR Officer'), ('METEOROLOGIST', 'Meteorologist'), ('CLIMATE_OFFICER', 'Climate Officer'), ('MARINE_OFFICER', 'Marine Officer'), ('SEISMIC_OFFICER', 'Seismic Officer'), ('EDITOR', 'Editor'), ('RESEARCHER', 'Researcher'), ('PUBLIC', 'Public User')], default='PUBLIC', max_length=20, verbose_name='Role')),
